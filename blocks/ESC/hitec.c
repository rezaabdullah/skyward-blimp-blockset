 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Oct 14 12:13:41 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME hitec
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void hitec_Outputs_wrapper(const real_T *micros,
			const real_T *xD,
			const real_T  *S_T, const int_T  p_width0,
			const real_T  *PIN, const int_T  p_width1);
extern void hitec_Update_wrapper(const real_T *micros,
			real_T *xD,
			const real_T  *S_T,  const int_T  p_width0,
			const real_T  *PIN,  const int_T  p_width1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    hitec_Outputs_wrapper(micros, xD, S_T, p_width0, PIN, p_width1);
