 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Oct  6 14:56:04 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME HCSR04
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void HCSR04_Outputs_wrapper(real_T *distance,
			const real_T *xD,
			const real_T  *S_T, const int_T  p_width0);
extern void HCSR04_Update_wrapper(const real_T *distance,
			real_T *xD,
			const real_T  *S_T,  const int_T  p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    HCSR04_Outputs_wrapper(distance, xD, S_T, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    HCSR04_Update_wrapper(distance,  xD, S_T, p_width0);
}
